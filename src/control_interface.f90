...
MODULE control_interface
    ...
    !
    PUBLIC :: get_nnt, get_nr1x, get_nr2x, get_nr3x
    !
    PUBLIC :: set_restart, is_restart, get_threshold
    !
    !------------------------------------------------------------------------------------
CONTAINS
    !------------------------------------------------------------------------------------
